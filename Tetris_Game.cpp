...
//   Version: 1.0.1.4 02/20/2013 BeiJing China [Updated 06/23/2013]      //
//                                                                       //
//   Algorithm:                                                          //
//                                                                       //
//   [][] [][]   [][]            [][]   [][]          [][]   [][] [][]   //
...
int get_args(vector<string>& args)
{
    ...
    else if ( args_len == 2 )
    {
       ...
       {
            cout << "Tetris Game  Version 1.0.1.4 [Updated 06/23/2013]" << endl;
            return 1;
       }
       else
       {
...
void board::notify()
{
     ...
     string str9 = to_string(toph+21)+";"+to_string(dist)+"H02/20/2013 BeiJing China [Updated 06/23/2013]";
     cout << str8+str9 << endl;
}
